...
class TestAsServer:
    ...
    def test_ps3i_xor(self):
        out = self._run("ps3i-xor",
            ...
            [[3000000000000000000, 4000000000000000001, 5000000000000000000, 6000000000000000001],
    ...
    def test_cpsi_add32(self):
        out = self._run("cpsi",
            ...
            [[0, 1, 1, 0], [1447575140, 2371119736, 382119735, 3447575141], [10, 20, 30, 40]],
            "--share-type", "add32"
        )
        assert parse_client_int_outputs(out) == [10, 60]
    ...
    def test_cpsi_xor(self):
        out = self._run("cpsi",
            [[1, 0, 1, 1], [2847392156, 1923847561, 3912847561, 847392156]],
            [[0, 1, 1, 0], [2847392156, 1923847560, 3912847561, 847392157], [10, 20, 30, 40]],
            "--share-type", "xor",
        )
        assert parse_client_int_outputs(out) == [10, 60]
