...
def generate_csv_files(sender_count, receiver_count, intersection_count, sender_file='sender.csv', receiver_file='receiver.csv'):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='generates input for testing protocols')
